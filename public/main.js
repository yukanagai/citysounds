...
var weatherK = '3c8e84ea9c6f7938384d3c3980033d80';
var echoK = '6ZYD20T5AIRI1KWF6';
...
var MusicApp = React.createClass({
	...
	generatePlaylist: function(artistGroup, city) {
		$.ajax({
			url: 'http://developer.echonest.com/api/v4/playlist/static?api_key='+echoK+'&artist='+artistGroup+'&format=json&results=10&type=artist&bucket=id:spotify-WW&limit=true&song_selection=song_hotttnesss-top&bucket=tracks&bucket=audio_summary&bucket=artist_location',
			method: 'GET',
